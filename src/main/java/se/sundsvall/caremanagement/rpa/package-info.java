 ...
 *
 * <p>
 * The bridge between CareManagement and the parts of Lifecare that have no FC API — bevakningar, journal, dokument, the
 * beslut itself, registering utbetalning. CareManagement does not drive Lifecare directly; it drops a UiPath
