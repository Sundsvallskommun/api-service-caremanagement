 ...
 * before
 * delegating to {@link SectionApprovalService}.
 *
 * <p>
 * <strong>Deprecated and inert.</strong> The approvals are Draken's old "Markera som komplett" check-offs. They are
 * recorded and read back, and nothing else depends on them: finalize ignores them, the decision proposal is computed on
 * every read and the medsökande payment warning is reconciled by the daily prepare. They are removed with the endpoints
 * once Draken stops calling them.
 * </p>
 */
@Service
@Transactional
