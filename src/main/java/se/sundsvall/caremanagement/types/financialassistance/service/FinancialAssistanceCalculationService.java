 ...
 * effective
 * draft to Lifecare FC ({@link #commitCalculation}). The errand envelope, its strongly-typed application data and the
 * case-history reads stay on {@link FinancialAssistanceService}; this service owns only the calculate/commit surface.
 */
@Service
@Transactional
