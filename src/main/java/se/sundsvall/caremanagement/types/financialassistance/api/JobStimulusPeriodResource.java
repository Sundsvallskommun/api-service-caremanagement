...
class JobStimulusPeriodResource {

	private final JobStimulusPeriodService service;

	JobStimulusPeriodResource(final JobStimulusPeriodService service) {
		this.service = service;
	}

	@GetMapping(produces = APPLICATION_JSON_VALUE)
	@Operation(summary = "List the errand's jobbstimulans periods", responses = {
		@ApiResponse(responseCode = "200", description = "Successful Operation", useReturnTypeSchema = true)
	})
	ResponseEntity<List<JobStimulusPeriod>> listJobStimulusPeriods(
