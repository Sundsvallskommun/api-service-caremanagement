...
public class Income {
	...
	@Schema(description = "The type of income (see GET .../errands/financial-assistance/metadata for the labelled catalogue)", examples = "SALARY_AFTER_TAX", allowableValues = {
		...
		"SURVIVOR_SUPPORT", "ESTABLISHMENT_BENEFIT", "PARENTAL_BENEFIT", "LODGING_ALLOWANCE", "CAPITAL_INCOME", "SALARY_AFTER_TAX", "PENSION", "PENSION_ANNUITY_CARE", "SICKNESS_COMPENSATION", "SICKNESS_BENEFIT", "TAX_REFUND", "SWISH_DEPOSITS_TRANSFERS",
		"MAINTENANCE_SUPPORT", "CARE_ALLOWANCE", "ELDERLY_SUPPORT", "SURPLUS_FROM_PREVIOUS_MONTH", "OTHER_INCOME"
	})
	@OneOf(value = {
		"UNEMPLOYMENT_BENEFIT", "UNEMPLOYMENT_OR_ALPHA_BENEFIT", "ACTIVITY_COMPENSATION", "ACTIVITY_SUPPORT", "ALPHA_BENEFIT", "CHILD_ALLOWANCE", "CHILD_PENSION", "HOUSING_ALLOWANCE", "HOUSING_SUPPLEMENT", "CSN_GRANT", "CSN_LOAN", "DAILY_ALLOWANCE_FK",
		"SURVIVOR_SUPPORT", "ESTABLISHMENT_BENEFIT", "PARENTAL_BENEFIT", "LODGING_ALLOWANCE", "CAPITAL_INCOME", "SALARY_AFTER_TAX", "PENSION", "PENSION_ANNUITY_CARE", "SICKNESS_COMPENSATION", "SICKNESS_BENEFIT", "TAX_REFUND", "SWISH_DEPOSITS_TRANSFERS",
