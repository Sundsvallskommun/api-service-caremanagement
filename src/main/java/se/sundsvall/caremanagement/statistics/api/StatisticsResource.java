...
class StatisticsResource {
	...
	@Operation(summary = "Errand statistics", description = "Aggregates the number of errands per status and per assigned user, optionally filtered by errand type and creation date.", responses = {
