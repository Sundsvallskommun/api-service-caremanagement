...
public class ErrandEntity implements Auditable {
	...
	public ErrandEntity withDecisions(final List<DecisionEntity> decisions) {
		this.decisions = decisions;
		return this;
	}
	...
	public boolean equals(final Object o) {
		...
		return Objects.equals(id, that.id) && Objects.equals(externalTags, that.externalTags) && Objects.equals(municipalityId, that.municipalityId) && Objects.equals(namespace, that.namespace) && Objects.equals(title, that.title)
			...
			&& Objects.equals(attachments, that.attachments) && Objects.equals(stakeholders, that.stakeholders) && Objects.equals(parameters, that.parameters) && Objects.equals(decisions, that.decisions)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, externalTags, municipalityId, namespace, title, category, type, status, description, priority, reporterUserId, assignedUserId, contactReason, contactReasonDescription, attachments, stakeholders, parameters, decisions,
