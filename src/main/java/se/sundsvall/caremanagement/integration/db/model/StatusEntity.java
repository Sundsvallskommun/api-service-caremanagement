...
@Table(name = "status",
	indexes = {
		@Index(name = "idx_status_namespace_municipality_id", columnList = "namespace, municipality_id")
	},
	uniqueConstraints = {
		@UniqueConstraint(name = "uq_status_namespace_municipality_id_name", columnNames = {
