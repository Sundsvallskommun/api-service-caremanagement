...
@Table(name = "`type`",
	indexes = {
		@Index(name = "idx_type_namespace_municipality_id", columnList = "namespace, municipality_id")
	},
	uniqueConstraints = {
		@UniqueConstraint(name = "uq_type_namespace_municipality_id_name", columnNames = {
...
public class TypeEntity {
	...
	public TypeEntity withMunicipalityId(final String municipalityId) {
		this.municipalityId = municipalityId;
		return this;
	}
	...
	public TypeEntity withNamespace(final String namespace) {
		this.namespace = namespace;
		return this;
	}
