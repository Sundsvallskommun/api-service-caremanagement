...
@Table(name = "role",
	indexes = {
		@Index(name = "idx_role_namespace_municipality_id", columnList = "namespace, municipality_id")
	},
	uniqueConstraints = {
		@UniqueConstraint(name = "uq_role_namespace_municipality_id_name", columnNames = {
