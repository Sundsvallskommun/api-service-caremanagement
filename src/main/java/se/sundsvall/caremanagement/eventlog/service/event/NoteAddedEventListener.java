...
/**
 * Records a published {@link NoteAdded} as a descriptive change-log row ({@code source = EVENT}) on the errand,
...
class NoteAddedEventListener {
	...
	NoteAddedEventListener(final ErrandEventService service) {
		this.service = service;
	}

	@ApplicationModuleListener
	void on(final NoteAdded event) {
