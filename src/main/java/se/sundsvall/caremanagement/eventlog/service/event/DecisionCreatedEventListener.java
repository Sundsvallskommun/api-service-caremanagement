...
/**
 * Records a published {@link DecisionCreated} as a descriptive change-log row ({@code source = EVENT}) on the errand,
 ...
 */
@Component
class DecisionCreatedEventListener {
	...
	DecisionCreatedEventListener(final ErrandEventService service) {
