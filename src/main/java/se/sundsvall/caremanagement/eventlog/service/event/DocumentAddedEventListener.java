...
/**
 * Records a published {@link DocumentAdded} as a descriptive change-log row ({@code source = EVENT}) on the errand,
 ...
 */
@Component
class DocumentAddedEventListener {
	...
	DocumentAddedEventListener(final ErrandEventService service) {
		this.service = service;
	}

	@ApplicationModuleListener
	void on(final DocumentAdded event) {
