...
/**
 * Records a published {@link JournalEntryAdded} as a descriptive change-log row ({@code source = EVENT}) on the errand,
 ...
 */
@Component
class JournalEntryAddedEventListener {
	...
	JournalEntryAddedEventListener(final ErrandEventService service) {
		this.service = service;
	}

	@ApplicationModuleListener
	void on(final JournalEntryAdded event) {
