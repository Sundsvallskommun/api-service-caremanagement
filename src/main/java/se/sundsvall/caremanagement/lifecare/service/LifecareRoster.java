 ...
 * the applicant, the co-applicant and the remaining household members (children). Lifecare supplies personal identity
 * number + name only; everything else on the form the citizen fills in.
 *
 ...
 *                    applying alone
 * @param members     every person on the latest calculation (identity number + name), applicant and co-applicant
 *                    included
 */
