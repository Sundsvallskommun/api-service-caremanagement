...
class NoteAddedEventListenerTest {
	...
	@InjectMocks
	private NoteAddedEventListener listener;
	...
	@Test
	void recordsNoteAddedAsDescriptiveEventRow() {
		listener.on(new NoteAdded("note-1", "errand-1", "2281", "EB", "carola01winberg", TS));
	...
	void defaultsActorToSystemWhenAuthorBlank() {
		listener.on(new NoteAdded("note-1", "errand-1", "2281", "EB", " ", TS));
