...
import static se.sundsvall.caremanagement.types.financialassistance.service.AteransokanDeltaService.DECISION_KEY;

@ExtendWith(MockitoExtension.class)
class AteransokanDeltaServiceTest {
	...
	@InjectMocks
	private AteransokanDeltaService service;
