...
class CalculationResponseTest {
	...
	@Test
	void testBean() {
		MatcherAssert.assertThat(CalculationResponse.class, allOf(
	...
	void testBuilderMethods() {
		final var response = CalculationResponse.create()
			...
			.withChangeWarnings(List.of("Bostadsbidrag: -23% (comparison 2400 -> control 1850)"));
		...
		assertThat(response.getChangeWarnings()).containsExactly("Bostadsbidrag: -23% (comparison 2400 -> control 1850)");
	}
