...
class ChildTest {
	...
	@Test
	void testBean() {
		MatcherAssert.assertThat(Child.class, allOf(
	...
	void testBuilderMethods() {
		...
		final var firstName = "Astrid";
		final var lastName = "Lindgren";
		final var schoolName = "Bredsands skola";
		final var residenceExtent = "FULL_TIME";
		final var daysInHome = 30;

		final var result = Child.create()
			.withPartyId(partyId)
	...
	void testNoDirtOnCreatedBean() {
		assertThat(Child.create()).hasAllNullFieldsOrProperties();
	}
}
