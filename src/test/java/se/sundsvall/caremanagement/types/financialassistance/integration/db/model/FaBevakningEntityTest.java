...
class FaBevakningEntityTest {
	...
	@Test
	void testBean() {
		assertThat(FaBevakningEntity.class, allOf(
	...
	void testBuilderMethods() {
		...
		final var entity = FaBevakningEntity.create()
			.withId("id")
			.withErrandId("errand")
			.withTitle("Följ upp")
	...
	void testNoDirtOnCreatedBean() {
		org.assertj.core.api.Assertions.assertThat(FaBevakningEntity.create()).hasAllNullFieldsOrProperties();
		org.assertj.core.api.Assertions.assertThat(new FaBevakningEntity()).hasAllNullFieldsOrProperties();
	}
