...
class NormberakningDraftTest {
	...
	void testNoDirtOnCreatedBean() {
		assertThat(NormberakningDraft.create()).hasAllNullFieldsOrPropertiesExcept("persons", "incomes", "expenses", "specialExpenses");
		assertThat(new NormberakningDraft()).hasAllNullFieldsOrPropertiesExcept("persons", "incomes", "expenses", "specialExpenses");
	}
}
