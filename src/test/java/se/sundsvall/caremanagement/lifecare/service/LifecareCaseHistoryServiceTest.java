...
class LifecareCaseHistoryServiceTest {
	...
	void listCalculationsMapsHeaderAndRows() {
		...
		when(lifecareFamilyCareIntegrationMock.getCalculations(PERSON_ID, "2026-01-01", "2026-06-30"))
	...
	void listCalculationsEmptyWhenNoPage() {
		when(lifecareFamilyCareIntegrationMock.getCalculations(PERSON_ID, "2026-01-01", "2026-06-30")).thenReturn(null);
	...
	void listDecisionsMapsHeaderAndPersons() {
		...
		when(lifecareFamilyCareIntegrationMock.getDecisions(PERSON_ID, "2026-01-01", "2026-06-30"))
	...
	void listDocumentsMapsMetadata() {
		...
		when(lifecareFamilyCareIntegrationMock.getDocuments(PERSON_ID, "2026-01-01", "2026-06-30"))
