...
class AktualiseringAssemblerTest {
	...
	void assemblesPersonAndDateWithoutProposal() {
		final var body = AktualiseringAssembler.assemble(PERSON_ID, null, DATE);
	...
	void picksFirstTypeReasonFromWhoOrganisationServiceAndInvestigation() {
		...
		final var body = AktualiseringAssembler.assemble(PERSON_ID, proposal, DATE);
